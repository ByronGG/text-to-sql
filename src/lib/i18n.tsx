...
const es = {
  ...
  upload: {
    ...
    loadAllSheets: (n: number) => `Cargar las ${n} hojas`,
    errorAllEmpty: "Ninguna hoja del Excel tenía datos.",
    cancel: "Cancelar",
...
const en: Messages = {
  ...
  upload: {
    ...
    loadAllSheets: (n: number) => `Load all ${n} sheets`,
    errorAllEmpty: "No sheet in the Excel file had data.",
    cancel: "Cancel",
